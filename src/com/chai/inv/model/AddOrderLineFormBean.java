...
public class AddOrderLineFormBean {
	...
	//note: it is not a column variable, only used for handling program functionality.
		//[when to insert a bean or update it, when order is open and you are adding one or more lines to it]
