...
//	}
	public UserWarehouseLabelValue(String userNameLabel, String userWarehouseLabel, String userWarehouseID) {
	...
	public void setUserwarehouseLabelValue(){
		this.x_USER_WAREHOUSE_LABEL.setText(MainApp.warehouseLvb.getExtra()+" : "+userWarehouseLabel);
