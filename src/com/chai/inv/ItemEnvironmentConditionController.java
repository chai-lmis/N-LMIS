...
public class ItemEnvironmentConditionController {
	...
	public void setItemEnvConditionBean(ItemEnvironmentConditionBean itemEnvConditionBean) {
	...
	public void setEnvironmentConditions(){
		...
		if(itemEnvConditionBean.getX_ITEM_ENVIRONMENT_ID() != null){
			...
			x_MIN_TEMPRATURE.setText(itemEnvConditionBean.getX_MINIMUM_TEMPRATURE());
			x_MAX_TEMPRATURE.setText(itemEnvConditionBean.getX_MAXIMUM_TEMPRATURE());
...
/*
	public void setItemBeanFields(ItemEnvironmentConditionBean envBean, String itemNumber){
		...
		itemEnvConditionBean.setX_ITEM_ENVIRONMENT_ID(envBean.getX_ITEM_ENVIRONMENT_ID());
		System.out.println("selected ENVIronment ID : "+envBean.getX_ITEM_ENVIRONMENT_ID());
	...
	public void setItemBeanFields(ItemBean itemBean) {
		...
		this.itemBean=itemBean;
		this.itemEnvConditionBean = new ItemEnvironmentConditionBean();
		x_MAX_TEMPRATURE.setText("");
		x_MIN_TEMPRATURE.setText("");
...
*/
	...
	public void handleSubmitEnvironmentCondition(){
		if(isValidate()){
			itemEnvConditionBean.setX_MINIMUM_TEMPRATURE(x_MIN_TEMPRATURE.getText());
			itemEnvConditionBean.setX_MAXIMUM_TEMPRATURE(x_MAX_TEMPRATURE.getText());
	...
	public boolean isValidate(){
		String errorMessage = "";
		if (x_MIN_TEMPRATURE.getText() == null || x_MAX_TEMPRATURE.getText().length() == 0){
			errorMessage += "No valid Minimum Temperature!\n";			
		}
			
		if (x_MAX_TEMPRATURE.getText() == null || x_MAX_TEMPRATURE.getText().length() == 0){
