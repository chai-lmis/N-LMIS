...
//    private ListView<String> notificationPaneListView = new ListView<String>();
//    
...
//                	ImageView image = new ImageView(NotificationTest.class.getResource("/resources/icons/NotificationBell.PNG").toExternalForm());
...
////            }
////        });
////        notificationPane.textProperty().addListener(new ChangeListener<String>() {
////            @Override public void changed(ObservableValue<? extends String> observable,String oldValue, String newValue) {
////            	if(newValue!=null && !newValue.equals("")){
...
//        root.getChildren().addAll(showBtn, cbSlideFromTop, textField); // ,cbUseDarkTheme
