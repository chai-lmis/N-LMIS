...
public class ActiveUserScreenController {
	...
	@FXML ComboBox<LabelValueBean> x_STATE_LIST;
	@FXML ComboBox<LabelValueBean> x_ACTIVE_LGA_LIST;
	@FXML TextField x_USERNAME;
	@FXML TextField x_PASSWORD;	
	private Stage dialogStage;
	private boolean okClicked=false;
	public void setDialogStage(Stage dialogStage) {
		this.dialogStage=dialogStage;
	}
	public void setInActiveWarehouseList(ObservableList<LabelValueBean> stateList,ObservableList<LabelValueBean> activateWarehouseList) {
	...
	@FXML public boolean handleOkClicked() {
		...
		if(x_USERNAME.getText()==null ||x_PASSWORD.getText()==null ){
			...
			if(x_ACTIVE_LGA_LIST.getValue()!=null){
				if(!CreateLogin.checkIsUserNameExist(x_USERNAME.getText())){ //check for unique usernames.					
					okClicked = CreateLogin.createUserLogin(x_ACTIVE_LGA_LIST.getValue(), x_USERNAME.getText(), x_PASSWORD.getText());
					if(okClicked){
	...
	@FXML void handleOnStateSelected(){
		System.out.println("**In ActiveUserScreen.handleOnStateSelected() listener **");
