...
public class MiscellaneousIssuesController {
	@FXML
	...
	public void handleOK() throws SQLException{
		System.out.println("In MiscellaneousIssuesController.handleOk() method...");
		if(isValid()){
			transactionBean = new TransactionBean();
			...
			transactionBean.setX_TRANSACTION_TYPE_CODE("MISC_ISSUE");
			...
			if(transactionService.insertMiscReceiveRecord(transactionBean)){
				...
				.message("Miscellaneous Issued Successfully.. ")
				.showInformation();
				dialogStage.close();
	...
	public boolean isValid(){
		System.out.println("In MiscellaneousIssuesController.isValid() method...");
		boolean flag = true;
		int onHandValue;
		int quantityValue;
		String errorMessage="";			
