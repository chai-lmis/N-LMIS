...
public class VendorIssueController{
	@FXML
	...
	public void handleOK() throws SQLException{
		System.out.println("In VendorIssueController.handleOk() method...");
		if(isValid()){
			transactionBean = new TransactionBean();
			...
			transactionBean.setX_TO_SOURCE("VENDOR");

			transactionBean.setX_FROM_SOURCE_ID(userBean.getX_USER_WAREHOUSE_ID());
			transactionBean.setX_TO_SOURCE_ID(x_VENDORS.getValue().getValue());
			...
			transactionBean.setX_TRANSACTION_TYPE_CODE("VENDOR_ISSUE");
			...
			if(transactionService.insertMiscReceiveRecord(transactionBean)){
				...
				.message("Vendor Issue Successfully.. ")
				.showInformation();
				dialogStage.close();
	...
	public boolean isValid(){
		System.out.println("In VendorIssueController.isValid() method...");
		boolean flag = true;
		int onHandValue;
		int quantityValue;
		String errorMessage="";		
