...
public class CheckItemSubInventories {
	...
	public static void insertUpdateTables(int warehouseId) {
		System.out
				.println("******************* Check Item SubInventories Started *********************");
				...
				while (localRs.next()) {
					...
					if (serverRs.next()) {
						...
						commonPStmt.setString(2,
								localRs.getString("SUBINVENTORY_CODE"));
						commonPStmt.setString(3,
								localRs.getString("SUBINVENTORY_DESCRIPTION"));
						commonPStmt.setString(4,
								localRs.getString("MAXIMUM_TEMPERATURE"));
						commonPStmt.setString(5,
								localRs.getString("MINIMUM_TEMPERATURE"));
					...
					sqlQuery = "UPDATE ITEM_SUBINVENTORIES SET "
							+ " SYNC_FLAG='Y' " + "WHERE SUBINVENTORY_ID = "
							+ localRs.getString("SUBINVENTORY_ID") + " "
							+ "  AND WAREHOUSE_ID =  "
							+ localRs.getString("WAREHOUSE_ID");
			...
			if (localConn != null && serverConn != null) {
				...
				while (serverRs.next()) {
					...
					if (localRs.next()) {
						...
						commonPStmt.setString(2,
								serverRs.getString("SUBINVENTORY_CODE"));
						commonPStmt.setString(3,
								serverRs.getString("SUBINVENTORY_DESCRIPTION"));
						commonPStmt.setString(4,
								serverRs.getString("MAXIMUM_TEMPERATURE"));
						commonPStmt.setString(5,
								serverRs.getString("MINIMUM_TEMPERATURE"));
						commonPStmt.setString(6, serverRs.getString("STATUS"));
						commonPStmt.setString(7,
								serverRs.getString("START_DATE"));
						commonPStmt
								.setString(8, serverRs.getString("END_DATE"));
						commonPStmt.setString(9,
