...
public class CheckOrderLine {
	...
	public static void insertUpdateTables(int warehouseId) {
		...
		System.out
				.println("******************* Check Order Line Started *********************");
			...
			if (localConn != null && serverConn != null) {
				...
				while (localRs.next()) {
					...
					if (serverRs.next()) {
						...
						sqlQuery = "UPDATE ORDER_LINES SET " + " ITEM_ID=?, " // 1
								+ " QUANTITY=?, " // 2
								+ " UOM=?, " // 3
								+ " CREATED_DATE=?, " // 4
								+ " LINE_STATUS_ID=?, "// 5
								...
								+ " CONSUMPTION_ID=? "// 24
								+ " WHERE ORDER_LINE_ID = ? "// 25
								+ "   AND ORDER_HEADER_ID =?";// 26
						...
						commonPStmt
								.setString(6, localRs.getString("SHIP_DATE"));
						...
						commonPStmt.setString(17,
								localRs.getString("RECEIVED_DATE"));
						commonPStmt.setString(18,
								localRs.getString("RECEIVED_QUANTITY"));
						commonPStmt.setString(19,
								localRs.getString("REFERENCE_LINE_ID"));
						...
						commonPStmt.setString(23,
								localRs.getString("CUST_PRODUCT_DETAIL_ID"));
						commonPStmt.setString(24,
								localRs.getString("CONSUMPTION_ID"));
						...
						commonPStmt.setString(7,
								localRs.getString("LINE_STATUS_ID"));
						commonPStmt
								.setString(8, localRs.getString("SHIP_DATE"));
						commonPStmt.setString(9,
								localRs.getString("SHIP_QUANTITY"));
						...
						commonPStmt.setString(13,
								localRs.getString("START_DATE"));
						commonPStmt
								.setString(14, localRs.getString("END_DATE"));
						commonPStmt.setString(15,
								localRs.getString("CREATED_BY"));
						commonPStmt.setString(16,
								localRs.getString("CREATED_ON"));
		...
		try {
			...
			if (localConn != null && serverConn != null) {
				...
				sqlQuery = "SELECT ORDER_LINE_ID, ORDER_HEADER_ID, ITEM_ID, "
						...
						+ "CUST_PRODUCT_DETAIL_ID,CONSUMPTION_ID "
						+ " FROM VW_ORDER_LINES " + " WHERE ( (ORDER_TO_ID = "
						+ warehouseId + " AND ORDER_TYPE_ID = F_GET_TYPE('Orders','PURCHASE ORDER')) "
						+ "      OR (ORDER_FROM_ID = " + warehouseId
				...
				while (serverRs.next()) {
					...
					if (localRs.next()) {
						...
						commonPStmt
								.setString(2, serverRs.getString("QUANTITY"));
						...
						commonPStmt.setString(17,
								serverRs.getString("RECEIVED_DATE"));
						commonPStmt.setString(18,
								serverRs.getString("RECEIVED_QUANTITY"));
						commonPStmt.setString(19,
								serverRs.getString("REFERENCE_LINE_ID"));
						commonPStmt.setString(20,
						...
						commonPStmt.setString(23,
								serverRs.getString("CUST_PRODUCT_DETAIL_ID"));
						commonPStmt.setString(24,
								serverRs.getString("CONSUMPTION_ID"));
						commonPStmt.setString(25,
								serverRs.getString("ORDER_LINE_ID"));
						commonPStmt.setString(26,
								serverRs.getString("ORDER_HEADER_ID"));
