...
public class CheckItemTransaction {
	...
	public static void insertUpdateTables(int warehouseId) {
		...
		System.out
				.println("******************* Check ITEM TRANSACTION Started *********************");
			...
			if (localConn != null && serverConn != null) {
				...
				while (localRs.next()) {
					...
					sqlQuery = "SELECT TRANSACTION_ID, ITEM_ID, FROM_SOURCE, FROM_SOURCE_ID, "
							...
							+ localRs.getString("TRANSACTION_ID");
					System.out
					...
					if (serverRs.next()) {
						...
						commonPStmt.setString(2,
								localRs.getString("FROM_SOURCE"));
						commonPStmt.setString(3,
								localRs.getString("FROM_SOURCE_ID"));
						commonPStmt
								.setString(4, localRs.getString("TO_SOURCE"));
						commonPStmt.setString(5,
								localRs.getString("TO_SOURCE_ID"));
						commonPStmt.setString(6,
								localRs.getString("FROM_SUBINVENTORY_ID"));
						commonPStmt.setString(7,
								localRs.getString("TO_SUBINVENTORY_ID"));
						commonPStmt.setString(8,
								localRs.getString("FROM_BIN_LOCATION_ID"));
						commonPStmt.setString(9,
								localRs.getString("TO_BIN_LOCATION_ID"));
						commonPStmt.setString(10,
								localRs.getString("LOT_NUMBER"));
						commonPStmt.setString(11,
								localRs.getString("TRANSACTION_TYPE_ID"));
						commonPStmt.setString(12,
								localRs.getString("TRANSACTION_QUANTITY"));
						commonPStmt.setString(13,
								localRs.getString("TRANSACTION_UOM"));
						commonPStmt.setString(14,
								localRs.getString("TRANSACTION_DATE"));
						commonPStmt.setString(15,
								localRs.getString("UNIT_COST"));
						...
						commonPStmt.setString(24,
								localRs.getString("TRANSACTION_NUMBER"));
						...
						commonPStmt.setString(29,
								localRs.getString("ONHAND_QUANTITY_AFTER_TRX"));
						commonPStmt.setString(30,
								localRs.getString("VVM_STAGE"));
						...
						commonPStmt.setString(4,
								localRs.getString("FROM_SOURCE_ID"));
						commonPStmt
								.setString(5, localRs.getString("TO_SOURCE"));
						commonPStmt.setString(6,
								localRs.getString("TO_SOURCE_ID"));
						commonPStmt.setString(7,
								localRs.getString("FROM_SUBINVENTORY_ID"));
						...
						commonPStmt.setString(19,
								localRs.getString("START_DATE"));
						commonPStmt
								.setString(20, localRs.getString("END_DATE"));
						commonPStmt.setString(21,
								localRs.getString("CREATED_BY"));
						commonPStmt.setString(22,
								localRs.getString("CREATED_ON"));
					...
					sqlQuery = "UPDATE ITEM_TRANSACTIONS SET "
							+ " SYNC_FLAG='Y' " + "WHERE TRANSACTION_ID = "
							+ localRs.getString("TRANSACTION_ID");
					System.out
							.println("Query to update item transaction on warehouse :: "
									+ sqlQuery);
		...
		try {
			...
			if (localConn != null && serverConn != null) {
				...
				sqlQuery = "SELECT TRANSACTION_ID, ITEM_ID, FROM_SOURCE, FROM_SOURCE_ID, "
						...
						+ "ONHAND_QUANTITY_AFTER_TRX ,VVM_STAGE "
						+ " FROM ITEM_TRANSACTIONS "
						+ "WHERE (FROM_SOURCE_ID = "+ warehouseId
						+ " OR TO_SOURCE_ID = "+ warehouseId
						+ ")  AND SYNC_FLAG = 'N' ";
				...
				while (serverRs.next()) {
					...
					if (localRs.next()) {
						...
						commonPStmt.setString(2,
								serverRs.getString("FROM_SOURCE"));
						commonPStmt.setString(3,
								serverRs.getString("FROM_SOURCE_ID"));
						commonPStmt.setString(4,
								serverRs.getString("TO_SOURCE"));
						commonPStmt.setString(5,
								serverRs.getString("TO_SOURCE_ID"));
						//
						commonPStmt.setString(6,
								serverRs.getString("FROM_SUBINVENTORY_ID"));
						commonPStmt.setString(7,
								serverRs.getString("TO_SUBINVENTORY_ID"));
						commonPStmt.setString(8,
								serverRs.getString("FROM_BIN_LOCATION_ID"));
						commonPStmt.setString(9,
								serverRs.getString("TO_BIN_LOCATION_ID"));
						commonPStmt.setString(10,
								serverRs.getString("LOT_NUMBER"));
						commonPStmt.setString(11,
								serverRs.getString("TRANSACTION_TYPE_ID"));
						commonPStmt.setString(12,
								serverRs.getString("TRANSACTION_QUANTITY"));
						commonPStmt.setString(13,
								serverRs.getString("TRANSACTION_UOM"));
						// this transaction_date was set as locaRs by nitesh sir
						commonPStmt.setString(14,
								serverRs.getString("TRANSACTION_DATE"));
						commonPStmt.setString(15,
								serverRs.getString("UNIT_COST"));
						...
						commonPStmt.setString(24,
								serverRs.getString("TRANSACTION_NUMBER"));
						commonPStmt.setString(25, "Y");
						...
						commonPStmt.setString(1,
								serverRs.getString("TRANSACTION_ID"));
