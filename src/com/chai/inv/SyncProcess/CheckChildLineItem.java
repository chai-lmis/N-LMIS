...
public class CheckChildLineItem {
    ...
    public static void insertUpdateTables(int warehouseId) {
        ...
        System.out.println("******************* Check CHILD LINE ITEM Started *********************");
            ...
            if (localConn != null && serverConn != null) {
                ...
                while (localRs.next()) {
                    ...
                    sqlQuery = "SELECT CHILD_LINE_ID, ORDER_LINE_ID, ORDER_HEADER_ID, ITEM_ID,QUANTITY, UOM, "
                            ...
                            + "SELF_LIFE, MFG_OR_REC_DATE, EXPIRATION_DATE "
                            + "FROM CHILD_LINE_ITEMS "
                            + "WHERE CHILD_LINE_ID = " + localRs.getString("CHILD_LINE_ID") + " "
                            + "  AND SHIP_FROM_WAREHOUSE_ID = " + localRs.getString("SHIP_FROM_WAREHOUSE_ID")+" "
                            + "  AND SHIP_TO_WAREHOUSE_ID = " + localRs.getString("SHIP_TO_WAREHOUSE_ID")+" ";
                    ...
                    if (serverRs.next()) {
                        ...
                        commonPStmt.setString(7, localRs.getString("BIN_LOCATION_ID"));
                        commonPStmt.setString(8, localRs.getString("LOT_NUMBER"));
                        commonPStmt.setString(9, localRs.getString("RECEIVE_QUANTITY"));
                        commonPStmt.setString(10, localRs.getString("CREATED_DATE"));
                        commonPStmt.setString(11, localRs.getString("LINE_STATUS_ID"));
                        commonPStmt.setString(12, localRs.getString("SHIP_DATE"));
                        commonPStmt.setString(13, localRs.getString("SHIP_QUANTITY"));
                        commonPStmt.setString(14, localRs.getString("CANCEL_DATE"));
                        commonPStmt.setString(15, localRs.getString("CANCEL_REASON"));
                        commonPStmt.setString(16, localRs.getString("STATUS"));
                        commonPStmt.setString(17, localRs.getString("START_DATE"));
                        commonPStmt.setString(18, localRs.getString("END_DATE"));
                        commonPStmt.setString(19, localRs.getString("CREATED_BY"));
                        commonPStmt.setString(20, localRs.getString("CREATED_ON"));
                        commonPStmt.setString(21, localRs.getString("UPDATED_BY"));
                        commonPStmt.setString(22, localRs.getString("LAST_UPDATED_ON"));
                        commonPStmt.setString(23, "N");
                        commonPStmt.setString(24, localRs.getString("SELF_LIFE"));
                        commonPStmt.setString(25, localRs.getString("MFG_OR_REC_DATE"));
                        commonPStmt.setString(26, localRs.getString("EXPIRATION_DATE"));
                        commonPStmt.setString(27, localRs.getString("CHILD_LINE_ID"));
                        commonPStmt.setString(28, localRs.getString("SHIP_FROM_WAREHOUSE_ID"));
                        commonPStmt.setString(29, localRs.getString("SHIP_TO_WAREHOUSE_ID"));
                        ...
                        commonPStmt.setString(1, localRs.getString("CHILD_LINE_ID"));
                        commonPStmt.setString(2, localRs.getString("ORDER_LINE_ID"));
                        commonPStmt.setString(3, localRs.getString("ORDER_HEADER_ID"));
                        ...
                        commonPStmt.setString(7, localRs.getString("SUBINVENTORY_ID"));
                        commonPStmt.setString(8, localRs.getString("BIN_LOCATION_ID"));
                        commonPStmt.setString(9, localRs.getString("LOT_NUMBER"));
                        commonPStmt.setString(10, localRs.getString("RECEIVE_QUANTITY"));
                        commonPStmt.setString(11, localRs.getString("CREATED_DATE"));
                        commonPStmt.setString(12, localRs.getString("LINE_STATUS_ID"));
                        commonPStmt.setString(13, localRs.getString("SHIP_DATE"));
                        commonPStmt.setString(14, localRs.getString("SHIP_QUANTITY"));
                        commonPStmt.setString(15, localRs.getString("CANCEL_DATE"));
                        commonPStmt.setString(16, localRs.getString("CANCEL_REASON"));
                        ...
                        commonPStmt.setString(25, localRs.getString("SHIP_FROM_WAREHOUSE_ID"));
                        commonPStmt.setString(26, localRs.getString("SHIP_TO_WAREHOUSE_ID"));
                        commonPStmt.setString(27, localRs.getString("SELF_LIFE"));
                        commonPStmt.setString(28, localRs.getString("MFG_OR_REC_DATE"));
                        commonPStmt.setString(29, localRs.getString("EXPIRATION_DATE"));                      
                    ...
                    sqlQuery = "UPDATE CHILD_LINE_ITEMS SET "
                            + " SYNC_FLAG='Y' "
                            + "WHERE CHILD_LINE_ID = " + localRs.getString("CHILD_LINE_ID");
                    System.out.println("Query to update child line on warehouse :: " + sqlQuery);
        ...
        try {
            ...
            if (localConn != null && serverConn != null) {
                ...
                sqlQuery = "SELECT CHILD_LINE_ID, ORDER_LINE_ID, ORDER_HEADER_ID, ITEM_ID,QUANTITY, UOM, "
                        ...
                        + "SELF_LIFE, MFG_OR_REC_DATE, EXPIRATION_DATE "
                        + "FROM CHILD_LINE_ITEMS "
                        + "WHERE SHIP_TO_WAREHOUSE_ID = " + warehouseId + " "
                        + "  AND SYNC_FLAG = 'N' ";
                ...
                while (serverRs.next()) {
                    ...
                    sqlQuery = "SELECT CHILD_LINE_ID, ORDER_LINE_ID, ORDER_HEADER_ID, ITEM_ID,QUANTITY, UOM, "
                            ...
                            + "SELF_LIFE, MFG_OR_REC_DATE, EXPIRATION_DATE "
                            + "FROM CHILD_LINE_ITEMS "
                            + "WHERE CHILD_LINE_ID = " + serverRs.getString("CHILD_LINE_ID");
                    ...
                    if (localRs.next()) {
                        ...
                        commonPStmt.setString(7, serverRs.getString("BIN_LOCATION_ID"));
                        commonPStmt.setString(8, serverRs.getString("LOT_NUMBER"));
                        commonPStmt.setString(9, serverRs.getString("RECEIVE_QUANTITY"));
                        commonPStmt.setString(10, serverRs.getString("CREATED_DATE"));
                        commonPStmt.setString(11, serverRs.getString("LINE_STATUS_ID"));
                        commonPStmt.setString(12, serverRs.getString("SHIP_DATE"));
                        commonPStmt.setString(13, serverRs.getString("SHIP_QUANTITY"));
                        commonPStmt.setString(14, serverRs.getString("CANCEL_DATE"));
                        commonPStmt.setString(15, serverRs.getString("CANCEL_REASON"));
                        commonPStmt.setString(16, serverRs.getString("STATUS"));
                        commonPStmt.setString(17, serverRs.getString("START_DATE"));
                        commonPStmt.setString(18, serverRs.getString("END_DATE"));
                        commonPStmt.setString(19, serverRs.getString("CREATED_BY"));
                        commonPStmt.setString(20, serverRs.getString("CREATED_ON"));
                        commonPStmt.setString(21, serverRs.getString("UPDATED_BY"));
                        commonPStmt.setString(22, serverRs.getString("LAST_UPDATED_ON"));
                        commonPStmt.setString(23, "Y");
                        commonPStmt.setString(24, serverRs.getString("SELF_LIFE"));
                        commonPStmt.setString(25, serverRs.getString("MFG_OR_REC_DATE"));
                        commonPStmt.setString(26, serverRs.getString("EXPIRATION_DATE"));
                        commonPStmt.setString(27, serverRs.getString("CHILD_LINE_ID"));
                        commonPStmt.setString(28, serverRs.getString("SHIP_FROM_WAREHOUSE_ID"));
                        commonPStmt.setString(29, serverRs.getString("SHIP_TO_WAREHOUSE_ID"));
                        ...
                        commonPStmt.setString(1, serverRs.getString("CHILD_LINE_ID"));
                        commonPStmt.setString(2, serverRs.getString("ORDER_LINE_ID"));
                        commonPStmt.setString(3, serverRs.getString("ORDER_HEADER_ID"));
                        commonPStmt.setString(4, serverRs.getString("ITEM_ID"));
                        commonPStmt.setString(5, serverRs.getString("QUANTITY"));
                        commonPStmt.setString(6, serverRs.getString("UOM"));
                        commonPStmt.setString(7, serverRs.getString("SUBINVENTORY_ID"));
                        commonPStmt.setString(8, serverRs.getString("BIN_LOCATION_ID"));
                        commonPStmt.setString(9, serverRs.getString("LOT_NUMBER"));
                        commonPStmt.setString(10, serverRs.getString("RECEIVE_QUANTITY"));
                        commonPStmt.setString(11, serverRs.getString("CREATED_DATE"));
                        commonPStmt.setString(12, serverRs.getString("LINE_STATUS_ID"));
                        commonPStmt.setString(13, serverRs.getString("SHIP_DATE"));
                        commonPStmt.setString(14, serverRs.getString("SHIP_QUANTITY"));
                        commonPStmt.setString(15, serverRs.getString("CANCEL_DATE"));
                        commonPStmt.setString(16, serverRs.getString("CANCEL_REASON"));
                        ...
                        commonPStmt.setString(25, serverRs.getString("SHIP_FROM_WAREHOUSE_ID"));
                        commonPStmt.setString(26, serverRs.getString("SHIP_TO_WAREHOUSE_ID"));
                        commonPStmt.setString(27, serverRs.getString("SELF_LIFE"));
                        commonPStmt.setString(28, serverRs.getString("MFG_OR_REC_DATE"));
                        commonPStmt.setString(29, serverRs.getString("EXPIRATION_DATE"));
