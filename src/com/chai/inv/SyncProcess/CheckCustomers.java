...
//                                + "   AND DEFAULT_STORE_ID = ? ";//34
                        ...
                        commonPStmt.setString(36, serverRs.getString("CUSTOMER_ID"));
//                        commonPStmt.setString(34, localRs.getString("DEFAULT_STORE_ID"));
                        ...
                        sqlQuery = "INSERT INTO customers"
                                ...
                                + "TARGET_POPULATION,EDIT_DATE,YEARLY_TP,SALESREP_ID)"
                                + "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                        System.out.println("Query to insert CUSTOMER_PRODUCT_CONSUMPTION on Server :: " + sqlQuery);
                        commonPStmt = serverConn.prepareStatement(sqlQuery);
                        commonPStmt.setString(1, localRs.getString("COMPANY_ID"));
                        commonPStmt.setString(2, localRs.getString("CUSTOMER_ID"));
                        commonPStmt.setString(3, localRs.getString("CUSTOMER_NUMBER"));
...
//                                + "   AND DEFAULT_STORE_ID = ? ";//34
                        ...
                        commonPStmt.setString(3, serverRs.getString("CUSTOMER_NUMBER"));
                        commonPStmt.setString(4, serverRs.getString("CUSTOMER_NAME"));
                        commonPStmt.setString(5, serverRs.getString("CUSTOMER_DESCRIPTION"));
                        commonPStmt.setString(6, serverRs.getString("CUSTOMER_CATEGORY_ID"));
                        commonPStmt.setString(7, serverRs.getString("HOMEPAGE"));
                        commonPStmt.setString(8, serverRs.getString("ADDRESS1"));
                        commonPStmt.setString(9, serverRs.getString("ADDRESS2"));
                        commonPStmt.setString(10, serverRs.getString("ADDRESS3"));
                        commonPStmt.setString(11, serverRs.getString("CITY_ID"));
                        commonPStmt.setString(12, serverRs.getString("STATE_ID"));
                        commonPStmt.setString(13, serverRs.getString("ZIP_CODE"));
                        commonPStmt.setString(14, serverRs.getString("COUNTRY_ID"));
                        commonPStmt.setString(15, serverRs.getString("PAYMENT_TERM_ID"));
                        commonPStmt.setString(16, serverRs.getString("DAY_PHONE_NUMBER"));
                        commonPStmt.setString(17, serverRs.getString("FAX_NUMBER"));
                        commonPStmt.setString(18, serverRs.getString("EMAIL_ADDRESS"));
                        commonPStmt.setString(19, serverRs.getString("STATUS"));
                        commonPStmt.setString(20, serverRs.getString("START_DATE"));
                        commonPStmt.setString(21, serverRs.getString("END_DATE"));
                        commonPStmt.setString(22, serverRs.getString("CREATED_BY"));
                        commonPStmt.setString(23, serverRs.getString("CREATED_ON"));
                        commonPStmt.setString(24, serverRs.getString("UPDATED_BY"));
                        commonPStmt.setString(25, serverRs.getString("LAST_UPDATED_ON"));
                        commonPStmt.setString(26, serverRs.getString("REFERENCE"));
                        commonPStmt.setString(27, serverRs.getString("DEFAULT_STORE_ID"));
                        commonPStmt.setString(28, serverRs.getString("CUSTOMER_TYPE_ID"));
                        commonPStmt.setString(29, serverRs.getString("VACCINE_FLAG"));
                        commonPStmt.setString(30, serverRs.getString("CHECK1"));
                        commonPStmt.setString(31, serverRs.getString("CHECK2"));
                        commonPStmt.setString(32, "Y");
                        commonPStmt.setString(33, serverRs.getString("TARGET_POPULATION"));
                        commonPStmt.setString(34, serverRs.getString("EDIT_DATE"));
                        commonPStmt.setString(35, serverRs.getString("YEARLY_TP"));
                        commonPStmt.setString(36, localRs.getString("CUSTOMER_ID"));
//                        commonPStmt.setString(34, serverRs.getString("DEFAULT_STORE_ID"));
                        System.out.println("commonPStmt :: " + commonPStmt.toString());
                        commonPStmt.executeUpdate();
                        System.out.println("Record updated successfully on warehouse....");
                        ...
                        commonPStmt.setString(34, serverRs.getString("EDIT_DATE"));
                        commonPStmt.setString(35, serverRs.getString("YEARLY_TP"));
                        commonPStmt.setString(36, serverRs.getString("SALESREP_ID"));
                        System.out.println("commonPStmt :: " + commonPStmt.toString());
                        commonPStmt.executeUpdate();
