...
public class CheckCustomersYearlyProductDetail {
	...
	public static void insertUpdateTables(int warehouseId) {
		...
		System.out
				.println("******************* Customer Yearly Product Detail Started *********************");
			...
			if (localConn != null && serverConn != null) {
				...
				while (localRs.next()) {
					...
					sqlQuery = "SELECT cus_prod_alloc_id, year, customer_id, item_id, target_coverage, target_population, max_factor, "
							...
							+ "LAST_UPDATED_ON,SYNC_FLAG, WAREHOUSE_ID "
							+ "FROM customer_yearly_product_allocation "
							+ "WHERE cus_prod_alloc_id = "
							+ localRs.getString("cus_prod_alloc_id")
							+ " "
							+ "  AND item_id = "
					...
					if (serverRs.next()) {
						...
						commonPStmt.setString(7,
								localRs.getString("max_factor"));
						commonPStmt.setString(8,
								localRs.getString("min_factor"));
						commonPStmt.setString(9,
								localRs.getString("allocation_factor"));
					...
					sqlQuery = "UPDATE customer_yearly_product_allocation SET "
							+ " SYNC_FLAG='Y' " + " WHERE cus_prod_alloc_id = "
							+ localRs.getString("cus_prod_alloc_id") + " "
							+ "   AND item_id =  "
							+ localRs.getString("item_id") + " "
							+ "   AND customer_id = "
			...
			if (localConn != null && serverConn != null) {
				...
				while (serverRs.next()) {
					...
					sqlQuery = "SELECT cus_prod_alloc_id, year, customer_id, item_id, target_coverage, target_population, max_factor, "
							...
							+ "FROM customer_yearly_product_allocation "
							+ "WHERE cus_prod_alloc_id = "
							+ serverRs.getString("cus_prod_alloc_id")
							+ " "
							+ "  AND item_id = "
					...
					if (localRs.next()) {
						...
						commonPStmt.setString(7,
								serverRs.getString("max_factor"));
						commonPStmt.setString(8,
								serverRs.getString("min_factor"));
						commonPStmt.setString(9,
								serverRs.getString("allocation_factor"));
						...
						commonPStmt.setString(20,
								serverRs.getString("customer_id"));
						commonPStmt
								.setString(21, serverRs.getString("item_id"));
