    ...
    public static void insertUpdateTables(int warehouseId) {
        ...
        try {
            ...
            if (localConn != null && serverConn != null) {
                ...
                sqlQuery = "SELECT ASSOCIATION_ID, ITEM_ID, AD_SYRINGE_ID, RECONSTITUTE_SYRNG_ID,AD_SYRINGE_CATEGORY_ID,RC_SYRINGE_CATEGORY_ID "
                        + " FROM SYRINGE_ASSOCIATION "
                ...
                while (serverRs.next()) {
                    ...
                    sqlQuery = "SELECT ASSOCIATION_ID, ITEM_ID, AD_SYRINGE_ID, RECONSTITUTE_SYRNG_ID,SYNC_FLAG,AD_SYRINGE_CATEGORY_ID,RC_SYRINGE_CATEGORY_ID "
                            + " FROM SYRINGE_ASSOCIATION "
