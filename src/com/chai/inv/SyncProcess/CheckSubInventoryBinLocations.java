...
public class CheckSubInventoryBinLocations {
    ...
    public static void insertUpdateTables(int warehouseId) {
        System.out.println("******************* Check Sub Inventory Bin Location Started *********************");
            ...
            if (localConn != null && serverConn != null) {
                ...
                while (localRs.next()) {
                    ...
                    if (serverRs.next()) {
                        ...
                        commonPStmt.setString(3, localRs.getString("BIN_LOCATION_CODE"));
                        commonPStmt.setString(4, localRs.getString("BIN_LOCATION_DESCRIPTION"));
                        ...
                        commonPStmt.setString(13, localRs.getString("BIN_LOCATION_ID"));
                        ...
                        commonPStmt.setString(3, localRs.getString("BIN_LOCATION_ID"));
                        commonPStmt.setString(4, localRs.getString("SUBINVENTORY_ID"));
                        commonPStmt.setString(5, localRs.getString("BIN_LOCATION_CODE"));
                        commonPStmt.setString(6, localRs.getString("BIN_LOCATION_DESCRIPTION"));
            ...
            if (localConn != null && serverConn != null) {
                ...
                while (serverRs.next()) {
                    ...
                    if (localRs.next()) {
                        ...
                        commonPStmt.setString(3, serverRs.getString("BIN_LOCATION_CODE"));
                        commonPStmt.setString(4, serverRs.getString("BIN_LOCATION_DESCRIPTION"));
                        ...
                        commonPStmt.setString(12,"Y");
                        commonPStmt.setString(13, serverRs.getString("BIN_LOCATION_ID"));
                        ...
                        commonPStmt.setString(3, serverRs.getString("BIN_LOCATION_ID"));
                        commonPStmt.setString(4, serverRs.getString("SUBINVENTORY_ID"));
                        commonPStmt.setString(5, serverRs.getString("BIN_LOCATION_CODE"));
                        commonPStmt.setString(6, serverRs.getString("BIN_LOCATION_DESCRIPTION"));
