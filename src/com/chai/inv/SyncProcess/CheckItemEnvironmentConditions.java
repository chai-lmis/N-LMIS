			...
			if (localConn != null && serverConn != null) {
				...
				while (localRs.next()) {
					...
					sqlQuery = "SELECT COMPANY_ID, ITEM_ID, MAXIMUM_TEMPRATURE, MINIMUM_TEMPRATURE, COMMENT, "
							...
							+ "FROM ITEM_ENVIRONMENT_CONDITIONS "
							+ "WHERE ITEM_ENVIRONMENT_ID  = "
							+ localRs.getString("ITEM_ENVIRONMENT_ID")
							+ " "
							+ "  AND WAREHOUSE_ID = "
					...
					if (serverRs.next()) {
						...
						commonPStmt.setString(3,
								localRs.getString("MAXIMUM_TEMPRATURE"));
						commonPStmt.setString(4,
								localRs.getString("MINIMUM_TEMPRATURE"));
					...
					sqlQuery = "UPDATE ITEM_ENVIRONMENT_CONDITIONS SET "
							...
							+ localRs.getString("WAREHOUSE_ID");
					System.out
							.println("Query to update ITEM_ENVIRONMENT_CONDITIONS on warehouse :: "
									+ sqlQuery);
			...
			if (localConn != null && serverConn != null) {
				...
				while (serverRs.next()) {
					...
					sqlQuery = "SELECT ITEM_ENVIRONMENT_ID, COMPANY_ID, ITEM_ID, MAXIMUM_TEMPRATURE, MINIMUM_TEMPRATURE, COMMENT, "
							...
							+ "FROM ITEM_ENVIRONMENT_CONDITIONS "
							+ "WHERE ITEM_ENVIRONMENT_ID = "
							+ serverRs.getString("ITEM_ENVIRONMENT_ID")
							+ ""
					...
					if (localRs.next()) {
						...
						commonPStmt.setString(4,
								serverRs.getString("MAXIMUM_TEMPRATURE"));
						commonPStmt.setString(5,
								serverRs.getString("MINIMUM_TEMPRATURE"));
