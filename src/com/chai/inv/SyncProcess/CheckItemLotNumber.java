...
public class CheckItemLotNumber {
    ...
    public static void insertUpdateTables(int warehouseId) {
        System.out.println("******************* Check ITEM LOT NUMBER Started *********************");
            ...
            if (localConn != null && serverConn != null) {
                ...
                while (localRs.next()) {
                    ...
                    if (serverRs.next()) {
                        ...
                        commonPStmt.setString(3, localRs.getString("LOT_NUMBER"));
                        commonPStmt.setString(4, localRs.getString("LOT_NUMBER_DESCRIPTION"));
                        commonPStmt.setString(5, localRs.getString("MFG_OR_REC_DATE"));
                        commonPStmt.setString(6, localRs.getString("SELF_LIFE"));
                        ...
                        commonPStmt.setString(15, localRs.getString("SUPPLIER_LOT_NUMBER"));
                        ...
                        commonPStmt.setString(19, localRs.getString("WAREHOUSE_ID"));
                        ...
                        commonPStmt.setString(5, localRs.getString("LOT_NUMBER_DESCRIPTION"));
                        commonPStmt.setString(6, localRs.getString("MFG_OR_REC_DATE"));
                        commonPStmt.setString(7, localRs.getString("SELF_LIFE"));
                        commonPStmt.setString(8, localRs.getString("EXPIRATION_DATE"));
                        ...
                        commonPStmt.setString(16, localRs.getString("SUPPLIER_LOT_NUMBER"));
            ...
            if (localConn != null && serverConn != null) {
                ...
                while (serverRs.next()) {
                    ...
                    if (localRs.next()) {
                        ...
                        commonPStmt.setString(3, serverRs.getString("LOT_NUMBER"));
                        commonPStmt.setString(4, serverRs.getString("LOT_NUMBER_DESCRIPTION"));
                        commonPStmt.setString(5, serverRs.getString("MFG_OR_REC_DATE"));
                        commonPStmt.setString(6, serverRs.getString("SELF_LIFE"));
                        ...
                        commonPStmt.setString(15, serverRs.getString("SUPPLIER_LOT_NUMBER"));
                        commonPStmt.setString(16, "Y");
                        commonPStmt.setString(17, serverRs.getString("ITEM_ID"));
                        commonPStmt.setString(18, serverRs.getString("LOT_NUMBER"));
                        commonPStmt.setString(19, serverRs.getString("WAREHOUSE_ID"));
                        ...
                        commonPStmt.setString(5, serverRs.getString("LOT_NUMBER_DESCRIPTION"));
                        commonPStmt.setString(6, serverRs.getString("MFG_OR_REC_DATE"));
                        commonPStmt.setString(7, serverRs.getString("SELF_LIFE"));
                        commonPStmt.setString(8, serverRs.getString("EXPIRATION_DATE"));
                        ...
                        commonPStmt.setString(16, serverRs.getString("SUPPLIER_LOT_NUMBER"));
                        commonPStmt.setString(17, "Y");
