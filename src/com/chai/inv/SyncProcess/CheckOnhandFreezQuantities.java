...
public class CheckOnhandFreezQuantities {
    ...
    public static void insertUpdateTables(int warehouseId) {
        ...
        System.out.println("******************* Onhand Freez Quantities Started *********************");
            ...
            if (localConn != null && serverConn != null) {
                ...
                while (localRs.next()) {
                    ...
                    if (serverRs.next()) {
                        ...
                        commonPStmt.setString(9, localRs.getString("FREEZ_DATE"));
                        ...
                        commonPStmt.setString(18, localRs.getString("BIN_LOCATION_ID"));
                        commonPStmt.setString(19, localRs.getString("LOT_NUMBER"));
            ...
            if (localConn != null && serverConn != null) {
                ...
                while (serverRs.next()) {
                    ...
                    if (localRs.next()) {
                        ...
                        commonPStmt.setString(9, serverRs.getString("FREEZ_DATE"));
                        ...
                        commonPStmt.setString(17, "Y");
                        commonPStmt.setString(18, serverRs.getString("BIN_LOCATION_ID"));
                        commonPStmt.setString(19, serverRs.getString("LOT_NUMBER"));
