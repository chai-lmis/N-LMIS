...
public class CategoryService {
	...
	public ObservableList<LabelValueBean> getDropdownList() {
		...
		try {
			...
			System.out.println("An error occured while getting Category_Type_Name list, to add in combobox, error: "+ ex.getMessage());
		}
		return null;
	}
	...
	public boolean saveCategory(CategoryBean categoryBean, String actionBtnString) throws SQLException{
		...
		try{
			...
			flag=false;
			System.out.println("Error while saving or editing Category, error: "+e.getMessage());
		}
//		finally{
//			dao.closeConnection();
//		}				 
	...
	public ObservableList<CategoryBean> getSearchList(CategoryBean toSearchCatgoryBean) {		
